...
export default function DealsPage() {
  ...
  const handleEdit = (deal: Deal) => {
    ...
    // Note: Backend uses ID for updates, but we might need slug for GET operations
    // For now, using ID - adjust if backend requires slug for GET
    router.push(`/en/deals/${deal._id}/edit`);
  };
